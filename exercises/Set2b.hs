...
oddFactorial 0 = 1
oddFactorial n = case (even n) of True -> oddFactorial (n - 1)
                                  False -> n * oddFactorial (n - 1)
...
myGcd a 0 = a
myGcd 0 b = b
myGcd a b = case a < b of True -> myGcd a (b - a)
                          False -> myGcd (a - b) b
...
leftpad str n = case (length str) < n of False -> str
                                         True -> " " ++ leftpad str (n - 1)
